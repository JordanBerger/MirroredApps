...
export function SkillsShowcase() {
  return (
    <section id="skills" className="py-20">
      <h2 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">Skills</h2>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        {skills.map((skill, index) => (
          <motion.div
            ...
            className={`bg-gradient-to-br ${skill.color} rounded-lg p-4 text-center shadow-lg`}
          >
